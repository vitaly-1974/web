...
String s = "";
s = "SELECT vmsqe_hosts.name,vmsqe_hosts.ping as ping1,vmsqe_hosts.state as state1,vmsqe_hosts.failed_jobs as failed_jobs1,vmsqe_hosts.os as os1,vmsqe_hosts.date as date1, vmsqe_changes.ping as ping2,vmsqe_changes.os as os2,vmsqe_changes.state as state2,vmsqe_changes.failed_jobs as failed_jobs2,vmsqe_changes.date_add as date2 FROM vmsqe_hosts RIGHT OUTER JOIN vmsqe_changes ON vmsqe_hosts.name = vmsqe_changes.name where vmsqe_changes.date_add is not null order by name,date2 desc";
// 1 - name, 2 - ping, 3 - state, 4 - failed, 5 - os, 6 - date
// 7 - ping,  8 - os, 9 - state, 10 - failed, 11 - date
